...
-- ----------------------------
-- Sequence structure for bot_agent_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "didaoj"."bot_agent_id_seq";
CREATE SEQUENCE "didaoj"."bot_agent_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Table structure for bot_agent
-- ----------------------------
DROP TABLE IF EXISTS "didaoj"."bot_agent";
CREATE TABLE "didaoj"."bot_agent" (
...
-- ----------------------------
ALTER SEQUENCE "didaoj"."bot_agent_id_seq"
OWNED BY "didaoj"."bot_agent"."id";
SELECT setval('"didaoj"."bot_agent_id_seq"', 1, true);
...
-- ----------------------------
-- Indexes structure for table bot_agent
-- ----------------------------
CREATE INDEX "bot_agent_game_id_index" ON "didaoj"."bot_agent" USING btree (
  "game_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "bot_agent_inserter_index" ON "didaoj"."bot_agent" USING btree (
  "inserter" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "bot_agent_language_index" ON "didaoj"."bot_agent" USING btree (
  "language" "pg_catalog"."int2_ops" ASC NULLS LAST
);
CREATE INDEX "bot_agent_version_index" ON "didaoj"."bot_agent" USING btree (
  "version" "pg_catalog"."int4_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table bot_agent
-- ----------------------------
ALTER TABLE "didaoj"."bot_agent" ADD CONSTRAINT "bot_agent_pk" PRIMARY KEY ("id");
...
-- ----------------------------
-- Foreign Keys structure for table bot_agent
-- ----------------------------
ALTER TABLE "didaoj"."bot_agent" ADD CONSTRAINT "bot_agent_bot_game_id_fk" FOREIGN KEY ("game_id") REFERENCES "didaoj"."bot_game" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "didaoj"."bot_agent" ADD CONSTRAINT "bot_agent_user_id_fk" FOREIGN KEY ("inserter") REFERENCES "didaoj"."user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
